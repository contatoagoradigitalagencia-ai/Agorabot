...
describe("ON - quick-messages:save_quick_message", () => {
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: null });
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: {} });
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: true });
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: 42 });
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: "string" });
	...
	// 	const res = await server.emit("quick-messages:save_quick_message", { phone: "5521999999999" });
