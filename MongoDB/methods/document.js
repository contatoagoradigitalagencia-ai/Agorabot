...
/**
 * @author VAMPETA
 * @brief METODO CRIADO PARA SALVAR MENSAGENS DE DOCUMENTOS NO MONGODB
 * @param {String} idPhone IDENTIFICADOR DO NUMERO DE TELEFONE DO BOT
 * @param {Object} message UM UNICO ELEMENTO DE req.body.entry[n].changes[n].value.messages[n]
*/
export async function saveDocumentReceived(idPhone, message) {
...
*/
export async function saveDocumentSent(idPhone, wamid, phone, data) {
